...
lr = 1e-4
_out = _err = f"logs/drawerfromego4dpretrainsplitbatch.log"
with open(_out,"wb") as out, open(_err,"wb") as err:
   command = f'python -u train_representation.py ' + \
      ...
      f'agent.size=50 experiment=drawerfromego4dpretrainsplitbatch dataset=something2something ' + \
      f'doaug=rctraj agent.l1weight=0.00001 batch_size=16 ' +\
      f'manifest_path=/home/ademi_adeniji/r3m/drawer_manifest.csv ' + \
      f'val_manifest_path=/home/ademi_adeniji/r3m/drawer_manifest_eval.csv ' + \
      f'wandbuser=adecyber wandbproject=r3mrlbench save_snapshot=True split_batch=True ' + \
